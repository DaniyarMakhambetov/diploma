...
urlpatterns = [
    ...
    path('adminlogin', LoginView.as_view(template_name='admin/login.html')),
    path('studentlogin', LoginView.as_view(template_name='student/login.html')),
    path('teacherlogin', LoginView.as_view(template_name='teacher/login.html')),
